...
const Customize = () => {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col items-center justify-center bg-gradient-to-t from-black to-[#030353] px-4 py-10">
      <div className="flex flex-wrap justify-center items-center gap-6 max-w-6xl w-full px-4">
        {/* Robot image cards */}
        <Card />
      ...
      {selectedImage && (
        <Button
          className="w-[100px] h-[40px] bg-blue-600 text-white hover:bg-blue-700 mt-6"
